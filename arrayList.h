...
class arrayList : public linearList<T> 
{
   public:
      ...
      //class seamlessPointer ;
      //seamlessPointer beginR() {return seamlessPointer(element);}
      //seamlessPointer endR() {return seamlessPointer(element + listSize);}
	...
	public:
	    ...
	    {
		// random iterators do arbitrary jumps in O{1) time
	        /*this->position = this->position + n ; 
	        return *this ;*/
		// increments in O(1) time without using a for loop as some of you did which completely shatters the idea of random access iterators
	    ...
	    seamlessPointer operator+(ptrdiff_t n)
	    {
	      ...
	      return seamlessPointer(iterator::position+n) ;// thanks to Jia Hu
	    }
	    ...
	    seamlessPointer operator-(ptrdiff_t n)
	    {
	      ...
	      //TODO deceremen tin constant time.
	    ...
	    {
	      // if I replace iterator:: with this-> I get a segfault, but if I reverse it i.e., ptr.position < this->position I don't get whic is very weird. But using :: everything is fine.
	      return iterator::position < ptr.position ;
	    }
	    // Here you basically do not need the functions that are commented below: (only < will suffice for sorting)
      ...
      //class seamlessPointer;
      //seamlessPointer begin() {return seamlessPointer(element);}
      //seamlessPointebidirectional_iterator_tagbidirectional_iterator_tagr end() {return seamlessPointer(element + listSize);}
